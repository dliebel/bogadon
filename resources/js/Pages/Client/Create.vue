...
const typeDocument = [
  { value: "CI", viewValue: "CI - Documento de Identidad" },
  { value: "DNI", viewValue: "DNI - Documento Nacional de Identidad" },
  { value: "PAS", viewValue: "PAS - Pasaporte" },
];
     ...
     <AppLayout title="Crear Cliente">
        ...
        <div class="m-6">
            <div class="max-w-12xl mx-auto ">
                ...
                <template #title> Crear Cliente</template>

                <template #description>
                    Formulario para crear cliente. Complete los datos requeridos
