        ...
        <div>
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                    ...
                    <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                        ...
                        <tr>
                            <th scope="col" class="px-6 py-4 font-medium text-gray-900"> Nombre / Apellido</th>
                        ...
                        <tr  v-for="c in clients" class="hover:bg-gray-50">
                            ...
                            <div class="text-sm">
                                <div class="font-medium text-gray-700">{{c.first_name}} {{c.last_name}}</div>
